...
extension MyProjectResponseDTO {
    static var projectTestArray: [MyProjectResponseDTO] = [
        ...
        MyProjectResponseDTO(projectID: 0, title: "모집 탭에서 보내는 두 번째 모집글입니다.", description: "기획부터 앱 출시까지 함께하실 팀원을 모집중입니다", deadline: "2023.08.20", status: "마감"),
        MyProjectResponseDTO(projectID: 0, title: "모집 탭에서 보내는 세 번째 모집글입니다.", description: "기획부", deadline: "2023.08.20", status: "마감"),
        MyProjectResponseDTO(projectID: 0, title: "모집 탭에서 보내는 네 번째 모집글입니다.", description: "기획", deadline: "2023.08.20", status: "마감"),
        MyProjectResponseDTO(projectID: 0, title: "모집 탭 모집글입니다.", description: "기획부터 앱 출시까지 함께하실 팀원을 모집중입니다", deadline: "2023.08.20", status: "현재 모집중"),
        MyProjectResponseDTO(projectID: 0, title: "모집", description: "기획부터 앱 출시까지", deadline: "2023.08.20", status: "현재 모집중")
    ]
}
