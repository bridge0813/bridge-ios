//
//  UpdateProjectScheduleViewController.swift
//  Bridge
//
...
/// 모집 마감일, 시작일, 완료일 수정 VC
final class UpdateProjectScheduleViewController: BaseViewController {
    // MARK: - UI
    ...
    // MARK: - Property
    private let viewModel: UpdateProjectScheduleViewModel
    
    // MARK: - Init
    init(viewModel: UpdateProjectScheduleViewModel) {
    ...
    // MARK: - Bind
    override func bind() {
        let input = UpdateProjectScheduleViewModel.Input(
            changedDate: datePickerPopUpView.completeButtonTapped,
