...
enum BridgeColor {
    ...
    static let primary2 = UIColor(red: 255 / 255, green: 227 / 255, blue: 208 / 255, alpha: 1)
    static let primary3 = UIColor(red: 255 / 255, green: 243 / 255, blue: 235 / 255, alpha: 1)
    static let primary4 = UIColor(red: 255 / 255, green: 246 / 255, blue: 240 / 255, alpha: 1)
    ...
    // gray scale
    static let gray01 = UIColor(red: 38 / 255, green: 42 / 255, blue: 52 / 255, alpha: 1)
    static let gray02 = UIColor(red: 89 / 255, green: 89 / 255, blue: 89 / 255, alpha: 1)
    static let gray03 = UIColor(red: 153 / 255, green: 157 / 255, blue: 174 / 255, alpha: 1)
    static let gray04 = UIColor(red: 176 / 255, green: 183 / 255, blue: 196 / 255, alpha: 1)
    static let gray05 = UIColor(red: 210 / 255, green: 214 / 255, blue: 222 / 255, alpha: 1)
    static let gray06 = UIColor(red: 233 / 255, green: 233 / 255, blue: 233 / 255, alpha: 1)
    static let gray07 = UIColor(red: 236 / 255, green: 236 / 255, blue: 236 / 255, alpha: 1)
    static let gray08 = UIColor(red: 241 / 255, green: 241 / 255, blue: 241 / 255, alpha: 1)
    static let gray09 = UIColor(red: 246 / 255, green: 246 / 255, blue: 246 / 255, alpha: 1)
